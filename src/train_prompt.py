...
from utils import MeanPooling, LSTMPooling, SoftEmbedding
...
@hydra.main(config_path="config", config_name="config_prompt")
def main(cfg: DictConfig):
    ...
    class Dataset(torch.utils.data.Dataset):
        ...
        def __getitem__(self, idx):
            ...
            return {
                "ids": [50256] * cfg.n_tokens + encoding["input_ids"], 
                "mask": [1] * cfg.n_tokens + encoding["attention_mask"],
                "targets": targets
            }
